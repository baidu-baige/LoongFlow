...
python agents/general_evolve/general_evolve_agent.py \
  --config agents/general_evolve/examples/heilbronn_problem_for_convex_regions/task_config.yaml \
  --initial-file agents/general_evolve/examples/heilbronn_problem_for_convex_regions/initial_program.py \
  --eval-file agents/general_evolve/examples/heilbronn_problem_for_convex_regions/eval_program.py \
  --log-level INFO
```
